#ifndef CMV_EDGE_DISTANCE
#define CMV_EDGE_DISTANCE 
...
namespace Ui {
	class CMvEdgeDistance;
}

class CMvEdgeDistance : public QWidget
{
    Q_OBJECT

public:
	//单例化
	static CMvEdgeDistance* Instance();
	//释放内存
	static void destroy();
...
private:
	Ui::CMvEdgeDistance *ui;

	static CMvEdgeDistance* s_pCMvEdgeDistance;

	CMvEdgeDistance(QWidget *parent = Q_NULLPTR);
	~CMvEdgeDistance();
