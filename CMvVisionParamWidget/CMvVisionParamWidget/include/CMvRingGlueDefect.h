#ifndef CMV_RING_GLUE_DEFECT
#define CMV_RING_GLUE_DEFECT

#include "CMvSecondLevelMenu.h"
#include <QMenu>

namespace Ui {
	class CMvRingGlueDefect;
}

class CMvRingGlueDefect : public QWidget
{
    Q_OBJECT

public:
	//单例化
	static CMvRingGlueDefect* Instance();
	//释放内存
	static void destroy();
...
private slots:
	...
	**=======================================结果判断槽函数==========================================**
	...
	//获取环胶显示
	void slotGetRingGlueDisplayIsChecked(bool State);
	...
	//获取环胶最小圆度 数值
	void slotGetRingGlueValue(double Value);
...
private:
	Ui::CMvRingGlueDefect *ui;

	static CMvRingGlueDefect* s_pCMvRingGlueDefect;

	CMvRingGlueDefect(QWidget *parent = Q_NULLPTR);
	~CMvRingGlueDefect();
