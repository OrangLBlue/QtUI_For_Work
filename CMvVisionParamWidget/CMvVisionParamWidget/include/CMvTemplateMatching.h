#ifndef CMV_TEMPLATE_MATCHING
#define CMV_TEMPLATE_MATCHING
...
namespace Ui {
	class CMvTemplateMatching;
}

class CMvTemplateMatching : public QWidget
{
    Q_OBJECT

public:
	//单例化
	static CMvTemplateMatching* Instance();
...
private:
	Ui::CMvTemplateMatching *ui;

	static CMvTemplateMatching* s_pCMvTemplateMatching;

	CMvTemplateMatching(QWidget *parent = Q_NULLPTR);
	~CMvTemplateMatching();
