#ifndef CMV_1D_CODE_RECOGNITION
#define CMV_1D_CODE_RECOGNITION 
...
namespace Ui {
	class CMv1DCodeRecognition;
}

class CMv1DCodeRecognition : public QWidget
{
    Q_OBJECT

public:
	//单例化
	static CMv1DCodeRecognition* Instance();
	//释放内存
	static void destroy();
...
private slots:
	...
	**=======================================结果判断槽函数==========================================**
	\*===============================================================================================*/
	//获取最多读码个数
	void slotGetReadNumberValue(int value);
	...
	//获取解码速度等级
	void slotGetDecodingSpeedRatingValue(int index);
...
private:
	Ui::CMv1DCodeRecognition *ui;

	static CMv1DCodeRecognition* s_pCMv1DCodeRecognition;

	CMv1DCodeRecognition(QWidget *parent = Q_NULLPTR);
	~CMv1DCodeRecognition();
