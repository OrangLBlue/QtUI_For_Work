#ifndef CMV_GRAPHIC_DEFECTS
#define CMV_GRAPHIC_DEFECTS 

#include "CMvSecondLevelMenu.h"
#include <QMenu>

namespace Ui {
	class CMvGraphicDefects;
}

class CMvGraphicDefects : public QWidget
{
    Q_OBJECT

public:
	//单例化
	static CMvGraphicDefects* Instance();
	//释放内存
	static void destroy();
...
private slots:
	...
	**=======================================结果判断槽函数==========================================**
	...
	//点击编辑图像模板
	void slotGetEditImageTemplateIsClick();
	...
	//获取缺陷最小灰度差
	void slotGetMinimumGrayscaleValue(int value);

	//获取缺陷最小面积
	void slotGetMinimumAreaValue(int value);
...
private:
	Ui::CMvGraphicDefects *ui;

	static CMvGraphicDefects* s_pCMvGraphicDefects;

	CMvGraphicDefects(QWidget *parent = Q_NULLPTR);
	~CMvGraphicDefects();
