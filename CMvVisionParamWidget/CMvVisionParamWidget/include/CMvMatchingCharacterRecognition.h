#ifndef CMV_MATCHING_CHARACTER_RECOGNITION
#define CMV_MATCHING_CHARACTER_RECOGNITION 
...
namespace Ui {
	class CMvMatchingCharacterRecognition;
}

class CMvMatchingCharacterRecognition : public QWidget
{
    Q_OBJECT

public:
	//单例化
	static CMvMatchingCharacterRecognition* Instance();
	//释放内存
	static void destroy();
	...
	//初始化界面
	void initCMvMatchingCharacterRecognition();
...
private slots:
	...
	**=======================================结果判断槽函数==========================================**
	\*===============================================================================================*/
	//获取字库训练方式
	void slotGetFontTrainingTypeValue(int index);

	//点击训练字库
	void slotCreateIsClick();

	//获取字库路径
	void slotGetLoadingValue();

	//点击字库路径
	void slotLoadingIsClick();
...
private:
	Ui::CMvMatchingCharacterRecognition *ui;

	static CMvMatchingCharacterRecognition* s_pCMvMatchingCharacterRecognition;

	CMvMatchingCharacterRecognition(QWidget *parent = Q_NULLPTR);
	~CMvMatchingCharacterRecognition();
