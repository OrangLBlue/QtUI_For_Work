#ifndef CMV_CONTOUR_MATCHING
#define CMV_CONTOUR_MATCHING 
...
namespace Ui {
	class CMvContourMatching;
}

class CMvContourMatching : public QWidget
{
    Q_OBJECT

public:
	//单例化
	static CMvContourMatching* Instance();
	//释放内存
	static void destroy();
...
private:
	Ui::CMvContourMatching *ui;

	static CMvContourMatching* s_pCMvContourMatching;

	CMvContourMatching(QWidget *parent = Q_NULLPTR);
	~CMvContourMatching();
